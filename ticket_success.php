...
<nav class="navbar navbar-expand-lg navbar-light " style="margin-bottom:30px" >
      <div class="container">
		...
		<h3 style="text-align:center">Your payment of &#x20b9; <?php echo $_SESSION['total_amount']; ?> has been received.<br><br> Your PNR is <strong><?php echo $_SESSION['pnr'];?></strong>. Your tickets have been booked successfully.</h3>
